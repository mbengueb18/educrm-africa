      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
          ...
          <div className="flex border-b border-gray-100 mt-3 px-5">
            ...
            <button onClick={() => setTab("iframe")} className={"py-2.5 px-3 text-xs font-semibold border-b-2 " + (tab === "iframe" ? "text-brand-600 border-brand-500" : "text-gray-500 border-transparent")}><Code size={13} className="inline mr-1" /> Intégration (iframe)</button>
          </div>
          ...
          <div className="p-5">
            {tab === "lien" ? (
              ...
              <>
                <p className="text-xs text-gray-500 mb-2">Collez ce code dans une page du site de l'école : le formulaire s'affiche intégré.</p>
