    ...
    <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className={cn("text-xs font-semibold px-2 py-0.5 rounded-full bg-brand-50 text-brand-700")}>
          ...
          <div className="space-y-4">
            {editMode ? (
              ...
              <>
                ...
                {user.campus && (
                  <InfoField icon={MapPin} label="Campus" value={user.campus.name + " — " + user.campus.city} />
                )}
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-gray-100">
          <h3 className="text-base font-bold text-gray-900 flex items-center gap-2"><Key size={16} /> Sécurité</h3>
        </div>
        <div className="p-6">
          {!showPasswordForm ? (
